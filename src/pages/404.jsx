...
export default function NotFound() {
  return (
    <section className="py-10">
      <Helmet>
        <title>Flavum HealthTech | Not Found</title>
      ...
      <div className="w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12 px-10">
            Sorry, the page you are looking for could not be found.
          </p>
          <Link
            to="/"
            className="flex items-center space-x-2 bg-primaryColor hover:bg-rose-700 text-gray-100 px-4 py-2 rounded transition duration-150"
            title="Return Home"
          >
            <svg
